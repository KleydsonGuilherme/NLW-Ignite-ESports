...
export function CreateAdModal(){
  ...
  async function handleCreateAd(event: FormEvent){
    ...
    try {
      ...
      console.log(err);
      alert('Falha ao criar o anuncio!')
    }
  }
            ...
            <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
                <div className='flex flex-col gap-2'>
                  ...
                  <select
                    name='game'
                    id='game'
                    className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none fas'
                    defaultValue=''
                  >
                    <option
                    disabled  
                    value="">Selecione o game que quer jogar                                    ▼ </option>
                ...
                <div className='grid grid-cols-2 gap-6'>
                  <div className='flex flex-col gap-2'>
                    ...
                    <Input name='yearPlaying' id='yearPlaying' placeholder='Tudo bem ser ZERO'/>
                  </div>
                  <div className='flex flex-col gap-2'>
